...
class TestWorkerMethods(unittest.TestCase):
    ...
    def test_parse_log_record(self):
        line = (b'1.196.116.32 -  - [29/Jun/2017:03:50:22 +0300] "GET /api/v2/banner/'
                b'24987703 HTTP/1.1" 200 883 "-" "Lynx/2.8.8dev.9 libwww-FM/2.14 '
                b'SSL-MM/1.4.1 GNUTLS/2.10.5" "-" "1498697422-2190034393-4708-9752753"'
                b'"dc7161be3" 0.726')
