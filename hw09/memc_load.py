...
from memc_connection import MemcacheClient
...
def insert_appsinstalled(memc_addr: str, appsinstalled: AppsInstalled, dry_run=False):
    ...
    try:
        if dry_run:
            ...
            memc_client = MemcacheClient(addr=addr)
